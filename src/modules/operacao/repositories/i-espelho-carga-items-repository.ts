...
interface IEspelhoCargaItemsRepository {
	...
	createWithQueryRunner({ espelhoCargaId, pacoteItemId, quantidade }: IEspelhoCargaItemsDTO, transactionManager: EntityManager): Promise<HttpResponse>
	...
	getByPacoteItemId(pacoteItemId: string): Promise<HttpResponse>
	...
	updateWithQueryRunner({ id, espelhoCargaId, pacoteItemId, quantidade }: IEspelhoCargaItemsDTO, transactionManager: EntityManager): Promise<HttpResponse>
	...
	deleteByEspelhoCargaIdWithQueryRunner(espelhoCargaId: string, transactionManager: EntityManager): Promise<HttpResponse>
}
