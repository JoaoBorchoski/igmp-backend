...
produtoRoutes.get("/select/:id", ensureAuthenticated, idSelectProdutoController.handle)
produtoRoutes.get("/select", ensureAuthenticated, selectProdutoController.handle)
