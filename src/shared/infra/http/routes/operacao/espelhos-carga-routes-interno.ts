...
import { CreateEspelhoCargaInternoController } from '@modules/operacao/use-cases/espelho-carga/create-espelho-carga-interno/create-espelho-carga-interno-controller'
import { UpdateEspelhoCargaInternoController } from '@modules/operacao/use-cases/espelho-carga/update-espelho-carga-interno/update-espelho-carga-interno-controller'
import { ListEspelhoCargaInternoController } from '@modules/operacao/use-cases/espelho-carga/list-espelho-carga-interno/list-espelho-carga-interno-controller'

const espelhosCargaRoutesInterno = Router()
...
const createEspelhoCargaInternoController = new CreateEspelhoCargaInternoController()
const updateEspelhoCargaInternoController = new UpdateEspelhoCargaInternoController()
const listEspelhoCargaInternoController = new ListEspelhoCargaInternoController()

espelhosCargaRoutesInterno.post('/', ensureAuthenticated, createEspelhoCargaInternoController.handle)
espelhosCargaRoutesInterno.post('/list', ensureAuthenticated, listEspelhoCargaInternoController.handle)
espelhosCargaRoutesInterno.post('/count', ensureAuthenticated, countEspelhoCargaController.handle)
espelhosCargaRoutesInterno.get('/select/:id', ensureAuthenticated, idSelectEspelhoCargaController.handle)
espelhosCargaRoutesInterno.get('/select', ensureAuthenticated, selectEspelhoCargaController.handle)
espelhosCargaRoutesInterno.get('/:id', ensureAuthenticated, getEspelhoCargaController.handle)
espelhosCargaRoutesInterno.put('/:id', ensureAuthenticated, updateEspelhoCargaInternoController.handle)
espelhosCargaRoutesInterno.delete('/:id', ensureAuthenticated, deleteEspelhoCargaController.handle)
espelhosCargaRoutesInterno.delete('/', ensureAuthenticated, multiDeleteEspelhoCargaController.handle)
espelhosCargaRoutesInterno.get('/export/:id', ensureAuthenticated, exportEspelhoCargaController.handle)
espelhosCargaRoutesInterno.post('/list-aberto', ensureAuthenticated, listEspelhoCargaAbertoController.handle)

export { espelhosCargaRoutesInterno }
